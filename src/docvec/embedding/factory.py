...
def create_embedding_provider(
    ...
    *,
    ...
    Args:
        ...
        model: Embedding model name. For 'ollama' defaults to 'nomic-embed-text'.
               For 'mlx', this parameter is ignored; use mlx_model instead.
    ...
    match backend:
        case "mlx":
            ...
            try:
                from docvec.embedding.mlx_provider import MLXProvider
        ...
        case "ollama":
            ...
            ollama_model = model if model else "nomic-embed-text"
            logger.info(
                f"Creating OllamaClient with host={host}, "
